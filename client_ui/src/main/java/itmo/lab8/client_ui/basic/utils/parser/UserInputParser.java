package itmo.lab8.client_ui.basic.utils.parser;


import itmo.lab8.client_ui.basic.types.builders.Builder;
import itmo.lab8.client_ui.basic.types.builders.BuilderFactory;
import itmo.lab8.client_ui.basic.types.builders.annotations.Generated;
import itmo.lab8.client_ui.basic.utils.parser.exceptions.BadArgumentException;
import itmo.lab8.client_ui.basic.utils.parser.exceptions.ObjectParsingException;
import itmo.lab8.client_ui.basic.utils.strings.StringUtils;
import itmo.lab8.client_ui.basic.utils.terminal.Colors;
...
public class UserInputParser extends AbstractParser {
    ...
    public <T> T readObject(Class<T> objectType) throws ObjectParsingException {
                ...
                try {
                    switch (field.getType().getSimpleName()) {
                        ...
                        default -> {
                            ...
                            try {
                                T innerObject = (T) readObject(field.getType());
