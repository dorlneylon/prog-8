...
import itmo.lab8.basic.auxiliary.Convertible;
...
import itmo.lab8.basic.utils.parser.ArgumentParser;
import itmo.lab8.basic.utils.parser.UserInputParser;
...
public final class CommandFactory {
    ...
    public static Movie parseMovie(CommandType type, String[] args) {
        if (Boolean.FALSE.equals(CollectionValidator.isMovieValid(type, name, args))) return null;
